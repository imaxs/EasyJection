 ...
 * COPYRIGHT NOTICE
 *
 * PropertyChangedEventArgs.cs content is partially copied from .Net reference source (https://referencesource.microsoft.com/).
 * Copyrights of their respective owners (Microsoft Corporation).
