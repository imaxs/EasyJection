...
namespace EasyJection
{
    ...
    public readonly struct MethodsData : IMethodsData
    {
        private readonly MethodInfo[] m_MethodsInfo;
        /// <inheritdoc cref="IMethodsData.MethodsInfo"/>
        public MethodInfo[] MethodsInfo { get => m_MethodsInfo; }

        private readonly ParameterInfo[][] m_MethodsParsInfo;
        /// <inheritdoc cref="IMethodsData.MethodsParsInfo"/>
        public ParameterInfo[][] MethodsParsInfo { get => m_MethodsParsInfo; }

        public MethodsData(MethodInfo[] methodsInfo, ParameterInfo[][] methodsParsInfo)
        {
            this.m_MethodsInfo = methodsInfo;
            this.m_MethodsParsInfo = methodsParsInfo;
        }
