...
namespace EasyJection.Binding
{
    public interface IBindingCondition
    {
        #region Comment
        /// <summary>
        /// Specified injection conditions
        /// </summary>
        /// <param name="bindingInstanceType">The type of the binding instance.</param>
        /// <returns>An instance of the implementation of the <see cref="IBindingInjection"/> interface.</returns>
        #endregion
        IBindingInjection As(BindingInstanceType bindingInstanceType);
